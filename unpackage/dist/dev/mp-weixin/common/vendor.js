...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__1397D60",
    appName: "AI-Recite-Ancient-Mobile",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.1.51,172.29.0.1";
  const port = "8090";
  const id = "mp-weixin_q2dlNy";
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "古诗词背诵 AI小助手"
    }
  },
  {
  ...
  {
    path: "pages/ancient/dictation",
    style: {
      navigationBarTitleText: "默写文章"
    }
  },
  {
    path: "pages/ancient/read",
    style: {
      navigationBarTitleText: "读文章"
    }
  },
  {
  ...
  {
    path: "pages/square/list",
    style: {
      navigationBarTitleText: "古文清单"
    }
  },
  {
  ...
  list: [
    {
      ...
      iconPath: "static/tabbar/tabbar-1.png",
      selectedIconPath: "static/tabbar/tabbar-1-a.png",
      text: "古文"
    },
    {
      pagePath: "pages/square/index",
      iconPath: "static/tabbar/tabbar-2.png",
      selectedIconPath: "static/tabbar/tabbar-2-a.png",
      text: "广场"
    },
    {
      pagePath: "pages/review/index",
      iconPath: "static/tabbar/tabbar-3.png",
      selectedIconPath: "static/tabbar/tabbar-3-a.png",
      text: "复盘"
    },
    {
      pagePath: "pages/ucenter/ucenter",
      iconPath: "static/tabbar/tabbar-4.png",
      selectedIconPath: "static/tabbar/tabbar-4-a.png",
      text: "我的"
    }
  ]
};
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.1.51","172.29.0.1"],"servePort":7001,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"alipay","spaceName":"ai-recite-ancient-mobile","spaceId":"env-00jy5xw5nv6i","spaceAppId":"2021006133633665","accessKey":"VB8z7Wko9ZZGIS5h","secretKey":"ogbicqC27huMLwLz"}]') || [];
let N = "";
try {
  N = "__UNI__1397D60";
} catch (e2) {
    ...
    }
    {
      ...
      if (!index.__stat_uniCloud_space) {
        if (space && Object.keys(space).length !== 0) {
          ...
          index.__stat_uniCloud_space = tr.init(spaceData);
        } else {
...
const getTraditionalWords = (word) => {
  ...
  for (let i2 = 0; i2 < word.length; i2++) {
    ...
    if (traditionalDict2[code]) {
      traditionalWords[i2] = traditionalDict2[code];
    } else {
      traditionalWords[i2] = key;
    }
  }
...
const validateType = (word) => {
  if (typeof word !== "string") {
    index.__f__("error", "at node_modules/pinyin-pro/dist/index.mjs:24239", "The first param of pinyin is error: " + word + ' is not assignable to type "string".');
    return false;
  } else {
    return true;
  }
