...
const _sfc_main = {
  ...
  methods: {
    ...
    quickLogin(e) {
      var _a, _b;
      let options = {};
      common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/pages/login/login-withoutpwd.vue:161", e);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: this.needAgreements && !this.agree
  }, this.needAgreements && !this.agree ? {
    i: common_vendor.o((...args) => $options.showAgreementModal && $options.showAgreementModal(...args))
  } : {}), {
    j: common_vendor.sr("agreements", "f1f87fcd-0"),
    k: common_vendor.p({
      scope: "register"
    })
  }) : {
    l: common_vendor.o((...args) => $options.chooseArea && $options.chooseArea(...args)),
    m: common_vendor.o(($event) => $data.focusPhone = false),
    n: common_vendor.o(($event) => $data.phone = $event),
    o: common_vendor.p({
      trim: "both",
    ...
    p: common_vendor.sr("agreements", "f1f87fcd-2"),
    q: common_vendor.p({
      scope: "register"
    }),
    r: common_vendor.o((...args) => $options.toSmsPage && $options.toSmsPage(...args))
  }, {
    s: common_vendor.sr("uniFabLogin", "f1f87fcd-3")
  });
}
