  ...
  methods: {
    ...
    async bindchooseavatar(res) {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at uni_modules/uni-id-pages/components/uni-id-pages-avatar/uni-id-pages-avatar.vue:95", e);
      }
      common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-avatar/uni-id-pages-avatar.vue:97", "avatar_file", avatar_file);
