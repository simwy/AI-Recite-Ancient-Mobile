...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "69f2bcc3-3-" + i0 + "-" + i1 + "," + ("69f2bcc3-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "69f2bcc3-2-" + i0 + "-" + i1 + "," + ("69f2bcc3-1-" + i0)
          };
        }),
        b: "69f2bcc3-1-" + i0 + ",69f2bcc3-0",
        c: "69f2bcc3-4-" + i0 + ",69f2bcc3-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "69f2bcc3-0"),
